...
<head>
    <meta charset="utf-8" />
    <title>成人游泳培训</title>
    <meta name="keywords" content="网站_成人" />
    <meta name="description" content="网站_成人" />
    ...
    <!--theme-->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/assets/adult/css/style.css" rel="stylesheet"><!-- 页面css -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/assets/adult/css/style.css" rel="stylesheet"><!-- 页面css -->
    <!--[if lt IE 9 ]>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/assets/adult/css/fixoldie.css">
    <![endif]-->
    <link href="${pageContext.request.contextPath}/static/assets/adult/css/scrollable-horizontal.css" rel="stylesheet" type="text/css" /><!-- 切换轮播css -->
    <link href="${pageContext.request.contextPath}/static/assets/adult/css/scrollable-buttons.css" rel="stylesheet" type="text/css" /><!-- 切换轮播css -->
    <link href="${pageContext.request.contextPath}/static/assets/adult/css/message.css" rel="stylesheet" type="text/css" /><!-- 提示信息/消息css -->


    <!--JS-->
    <script src="${pageContext.request.contextPath}/static/assets/adult/js/jquery.1.11.3.min.js"></script><!-- jquery js -->

    <script src="${pageContext.request.contextPath}/static/assets/adult/js/base.js"></script><!-- 页面 js -->

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/jquery.tools.js"></script><!-- jquery tools js -->


    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/echarts.js"></script><!-- 图表工具js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/echarts.min.js"></script><!-- 图表工具js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/Chart.js"></script><!-- 图表工具js -->

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/uuid.js"></script>

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/jsbn.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/prng4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/rng.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/rsa.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/base64.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/jquery.validate.js"></script><!-- jquery validate js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/common.js"></script><!-- common 引用 js -->

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/jquery.placeholder.js"></script>

    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/adult/css/idialog.css"/><!-- artdialog弹出框css-->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/jquery.artDialog.js"></script><!-- artdialog弹出框js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/admincustom.js"></script>

    <!--验证框架自定义样式-->
    <link type="text/css" href="${pageContext.request.contextPath}/static/assets/adult/css/tip-yellow.css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/adult/js/jquery.poshytip.js"></script>
...
<div class="container">
    <div class="wrap_main">
        <!--main wrap start-->
        <div class="swimming-train adult_swimming">
            ...
            <div class="advanced-section">
                ...
                <p class="train-desc">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;冷康游泳俱乐部为成年学员量身定制高效学习计划，将“学习”和“练习”相结合，在专业教练员的指导下，快速有效的达到游泳学习和健身塑型的双重效果。冷康游泳俱乐部拥有世界顶级的场馆设施，新颖实用的教学体系，专业负责的教练员，在这里，您将接触到最专业、最安全、最有效的游泳培训课程。通过我们的课程，更多的学员学会游泳、爱上游泳，并逐步建立起游泳健身的理念，养成良好的生活习惯。
                    <img src="${pageContext.request.contextPath}/static/assets/adult/images/cr.jpg" alt=""/>
                </p>
            </div>
            <!--课程时间表-->
            <div class="advanced-section">
