...
<head>
    <meta charset="utf-8" />
    <title>少儿游泳培训</title>
    <meta name="keywords" content="网站_少儿" />
    <meta name="description" content="网站_少儿" />
    ...
    <!--theme-->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/assets/teenager/css/style.css" rel="stylesheet"><!-- 页面css -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/assets/teenager/css/style.css" rel="stylesheet"><!-- 页面css -->
    <!--[if lt IE 9 ]>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/assets/teenager/css/fixoldie.css">
    <![endif]-->
    <link href="${pageContext.request.contextPath}/static/assets/teenager/css/scrollable-horizontal.css" rel="stylesheet" type="text/css" /><!-- 切换轮播css -->
    <link href="${pageContext.request.contextPath}/static/assets/teenager/css/scrollable-buttons.css" rel="stylesheet" type="text/css" /><!-- 切换轮播css -->
    <link href="${pageContext.request.contextPath}/static/assets/teenager/css/message.css" rel="stylesheet" type="text/css" /><!-- 提示信息/消息css -->


    <!--JS-->
    <script src="${pageContext.request.contextPath}/static/assets/teenager/js/jquery.1.11.3.min.js"></script><!-- jquery js -->

    <script src="${pageContext.request.contextPath}/static/assets/teenager/js/base.js"></script><!-- 页面 js -->

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/jquery.tools.js"></script><!-- jquery tools js -->


    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/echarts.js"></script><!-- 图表工具js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/echarts.min.js"></script><!-- 图表工具js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/Chart.js"></script><!-- 图表工具js -->

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/uuid.js"></script>

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/jsbn.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/prng4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/rng.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/rsa.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/base64.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/jquery.validate.js"></script><!-- jquery validate js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/common.js"></script><!-- common 引用 js -->

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/jquery.placeholder.js"></script>

    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/teenager/css/idialog.css"/><!-- artdialog弹出框css-->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/jquery.artDialog.js"></script><!-- artdialog弹出框js -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/admincustom.js"></script>

    <!--验证框架自定义样式-->
    <link type="text/css" href="${pageContext.request.contextPath}/static/assets/teenager/css/tip-yellow.css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/assets/teenager/js/jquery.poshytip.js"></script>
...
<div class="container">
    ...
    <div class="wrap_main">
        <!--main wrap start-->
        <div class="swimming-train teenager_swimming">
            ...
            <div class="advanced-section">
                ...
                <p class="train-desc">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;少儿学员专属的培训泳池，利用水的浮力、阻力、压力等不稳定特性，通过水中游戏、岸上模仿、水中练习等课程编排，逐步学会标准游泳技术。并在游泳锻炼中获得健康、增强体质，同时提高沟通和交往能力，培养孩子自信、自律和独立性，促进孩子的全面发展。
                    <img src="${pageContext.request.contextPath}/static/assets/teenager/images/sr.jpg" alt=""/>
                </p>
            </div>
            <!--课程时间表-->
            <div class="advanced-section">
