...
<div id="bg">
    ...
    <div id="login_wrap">
        <div id="login">
            ...
            <span>
                    <form action="post">
                        <p class="form"><input type="text" id="user" placeholder="电话号码"></p>
                    ...
                    <a href="${pageContext.request.contextPath}/account/register">还没有帐号,立即注册</a>
                    <a href="${pageContext.request.contextPath}/account/find">忘记密码?</a>
                </span>
        </div>
...
<script>
    ...
    function login() {
        if (email.value.length < 1){
            hit.innerHTML = "请您输入账号后再登录";
        }
        else if (password.value.length < 1){
            hit.innerHTML = "请您输入密码后再登录" ;
        }
        else{

            $.post("${pageContext.request.contextPath}/account/login", {phone:email.value, password:password.value},function(result){
